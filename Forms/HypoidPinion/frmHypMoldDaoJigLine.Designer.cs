...
namespace BMS
{
    partial class frmHypMoldDaoJigLine
	{
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            ((object)(222D))});
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmHypMoldDaoJigLine));
			...
			this.colEvaluate = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.txtCurrentSTD = new System.Windows.Forms.TextBox();
			this.label10 = new System.Windows.Forms.Label();
			this.label11 = new System.Windows.Forms.Label();
			this.label13 = new System.Windows.Forms.Label();
			this.label14 = new System.Windows.Forms.Label();
			this.txtCode = new System.Windows.Forms.TextBox();
			this.txtCurrentATC = new System.Windows.Forms.TextBox();
			this.txtSTD = new System.Windows.Forms.TextBox();
			this.txtRemainQty = new System.Windows.Forms.TextBox();
			this.label12 = new System.Windows.Forms.Label();
			this.panel4 = new System.Windows.Forms.Panel();
			this.label8 = new System.Windows.Forms.Label();
			this.grdDataJig = new DevExpress.XtraGrid.GridControl();
			this.grvDataJig = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.colKnifeCodeReal = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colPeriodValueJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colReal = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colRateJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colMinJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colMaxJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colKnifeDetailListID = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colCheckValueTypeJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colUnitJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colSortOrderJig = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colWorkingNameJig = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			((System.ComponentModel.ISupportInitialize)(this.grdDataJig)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.grvDataJig)).BeginInit();
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50.58731F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 49.41269F));
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(1277, 837);
			...
			this.tableLayoutPanel1.SetColumnSpan(this.grdData, 2);
			this.grdData.Location = new System.Drawing.Point(3, 3);
			this.grdData.MainView = this.grvData;
			this.grdData.Name = "grdData";
			this.grdData.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemMemoEdit1});
			this.grdData.Size = new System.Drawing.Size(1271, 244);
			...
			this.colWorkingName.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colWorkingName.OptionsFilter.AllowFilter = false;
			this.colWorkingName.OptionsFilter.FilterBySortField = DevExpress.Utils.DefaultBoolean.False;
			this.colWorkingName.Visible = true;
			this.colWorkingName.VisibleIndex = 0;
			this.colWorkingName.Width = 390;
			// 
			...
			this.colPeriodValue.ColumnEdit = this.repositoryItemMemoEdit1;
			this.colPeriodValue.FieldName = "PeriodValue";
			this.colPeriodValue.Name = "colPeriodValue";
			this.colPeriodValue.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colPeriodValue.OptionsFilter.AllowAutoFilter = false;
			this.colPeriodValue.OptionsFilter.AllowFilter = false;
			this.colPeriodValue.Visible = true;
			this.colPeriodValue.VisibleIndex = 1;
			this.colPeriodValue.Width = 264;
			// 
			// colRealvalue
			// 
			...
			this.colRealvalue.FieldName = "Real1";
			...
			this.colSortOrder.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colCondition
			// 
			...
			this.colCondition.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colCondition.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.colUnit.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// colEvaluate
			// 
			this.colEvaluate.AppearanceCell.Options.UseTextOptions = true;
			this.colEvaluate.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colEvaluate.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colEvaluate.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colEvaluate.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colEvaluate.AppearanceHeader.Options.UseFont = true;
			this.colEvaluate.AppearanceHeader.Options.UseTextOptions = true;
			this.colEvaluate.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colEvaluate.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colEvaluate.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colEvaluate.Caption = "Đánh giá";
			this.colEvaluate.FieldName = "Rate";
			this.colEvaluate.Name = "colEvaluate";
			this.colEvaluate.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colEvaluate.OptionsFilter.AllowAutoFilter = false;
			this.colEvaluate.Visible = true;
			this.colEvaluate.VisibleIndex = 4;
			this.colEvaluate.Width = 95;
			// 
			// colX
			// 
			...
			this.colX.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colX.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colX.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.colX.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			...
			this.colY.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colY.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colY.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.colY.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			...
			this.colMinValue.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.colMinValue.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			...
			this.colMinValue.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colMaxValue
			// 
			...
			this.colMaxValue.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.colMaxValue.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			...
			this.colMaxValue.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colisDisplay
			// 
			this.colisDisplay.AppearanceCell.Options.UseTextOptions = true;
			this.colisDisplay.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colisDisplay.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colisDisplay.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colisDisplay.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colisDisplay.AppearanceHeader.Options.UseFont = true;
			this.colisDisplay.AppearanceHeader.Options.UseTextOptions = true;
			this.colisDisplay.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colisDisplay.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colisDisplay.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colisDisplay.Caption = "Hiển thị";
			this.colisDisplay.FieldName = "isDisplay";
			this.colisDisplay.Name = "colisDisplay";
			this.colisDisplay.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colCheckValueType
			// 
			...
			this.colCheckValueType.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colID
			// 
			...
			this.panel3.Size = new System.Drawing.Size(639, 581);
			...
			xyDiagram1.AxisX.Title.Text = "NGÀY GIA CÔNG";
			...
			xyDiagram1.AxisY.Title.Text = "SỐ LẦN GIA CÔNG ";
			xyDiagram1.AxisY.Title.Visible = true;
			xyDiagram1.AxisY.VisibleInPanesSerializable = "-1";
			this.chartControl1.Diagram = xyDiagram1;
			this.chartControl1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.chartControl1.Enabled = false;
			this.chartControl1.Legend.Visible = false;
			this.chartControl1.Location = new System.Drawing.Point(0, 138);
        ...
        series1};
			...
			this.chartControl1.Size = new System.Drawing.Size(639, 443);
			...
			this.tableLayoutPanel2.Controls.Add(this.txtCurrentSTD, 2, 2);
			...
			this.tableLayoutPanel2.Controls.Add(this.txtCode, 0, 2);
			this.tableLayoutPanel2.Controls.Add(this.txtCurrentATC, 1, 2);
			this.tableLayoutPanel2.Controls.Add(this.txtSTD, 3, 2);
			this.tableLayoutPanel2.Controls.Add(this.txtRemainQty, 4, 2);
			...
			this.tableLayoutPanel2.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayoutPanel2.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayoutPanel2.Size = new System.Drawing.Size(639, 138);
			...
			this.label9.Size = new System.Drawing.Size(637, 43);
			this.label9.TabIndex = 16;
			this.label9.Text = "THÔNG TIN DAO";
			this.label9.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// txtCurrentSTD
			// 
			this.txtCurrentSTD.BackColor = System.Drawing.Color.White;
			this.txtCurrentSTD.Dock = System.Windows.Forms.DockStyle.Fill;
			this.txtCurrentSTD.Font = new System.Drawing.Font("Microsoft Sans Serif", 24F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtCurrentSTD.Location = new System.Drawing.Point(255, 93);
			this.txtCurrentSTD.Margin = new System.Windows.Forms.Padding(1);
			this.txtCurrentSTD.Name = "txtCurrentSTD";
			this.txtCurrentSTD.ReadOnly = true;
			this.txtCurrentSTD.Size = new System.Drawing.Size(125, 44);
			this.txtCurrentSTD.TabIndex = 20;
			// 
			// label10
			// 
			...
			this.label10.Text = "SỐ LƯỢNG CÒN LẠI";
			...
			this.label14.Location = new System.Drawing.Point(128, 47);
			this.label14.Margin = new System.Windows.Forms.Padding(1);
			this.label14.Name = "label14";
			this.label14.Size = new System.Drawing.Size(125, 44);
			this.label14.TabIndex = 3;
			this.label14.Text = "SỐ LẦN MÀI";
			...
			this.txtCode.Location = new System.Drawing.Point(1, 93);
			this.txtCode.Margin = new System.Windows.Forms.Padding(1);
			this.txtCode.Name = "txtCode";
			this.txtCode.ReadOnly = true;
			this.txtCode.Size = new System.Drawing.Size(125, 44);
			...
			// txtCurrentATC
			// 
			this.txtCurrentATC.BackColor = System.Drawing.Color.White;
			this.txtCurrentATC.Dock = System.Windows.Forms.DockStyle.Fill;
			this.txtCurrentATC.Font = new System.Drawing.Font("Microsoft Sans Serif", 24F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtCurrentATC.Location = new System.Drawing.Point(128, 93);
			this.txtCurrentATC.Margin = new System.Windows.Forms.Padding(1);
			this.txtCurrentATC.Name = "txtCurrentATC";
			this.txtCurrentATC.ReadOnly = true;
			this.txtCurrentATC.Size = new System.Drawing.Size(125, 44);
			this.txtCurrentATC.TabIndex = 21;
			// 
			// txtSTD
			// 
			this.txtSTD.BackColor = System.Drawing.Color.White;
			this.txtSTD.Dock = System.Windows.Forms.DockStyle.Fill;
			this.txtSTD.Font = new System.Drawing.Font("Microsoft Sans Serif", 24F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtSTD.Location = new System.Drawing.Point(382, 93);
			this.txtSTD.Margin = new System.Windows.Forms.Padding(1);
			this.txtSTD.Name = "txtSTD";
			this.txtSTD.ReadOnly = true;
			this.txtSTD.Size = new System.Drawing.Size(125, 44);
			this.txtSTD.TabIndex = 7;
			// 
			// txtRemainQty
			// 
			this.txtRemainQty.BackColor = System.Drawing.Color.White;
			this.txtRemainQty.Dock = System.Windows.Forms.DockStyle.Fill;
			this.txtRemainQty.Font = new System.Drawing.Font("Microsoft Sans Serif", 24F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtRemainQty.Location = new System.Drawing.Point(509, 93);
			this.txtRemainQty.Margin = new System.Windows.Forms.Padding(1);
			this.txtRemainQty.Name = "txtRemainQty";
			this.txtRemainQty.ReadOnly = true;
			this.txtRemainQty.Size = new System.Drawing.Size(129, 44);
			this.txtRemainQty.TabIndex = 8;
			// 
			// label12
			// 
			...
			this.label12.Size = new System.Drawing.Size(125, 44);
			this.label12.TabIndex = 2;
			this.label12.Text = "MÃ DỤNG CỤ";
			this.label12.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// panel4
			// 
			this.panel4.Controls.Add(this.label8);
			this.panel4.Controls.Add(this.grdDataJig);
			this.panel4.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panel4.Location = new System.Drawing.Point(648, 253);
			this.panel4.Name = "panel4";
			this.panel4.Size = new System.Drawing.Size(626, 581);
			...
			this.label8.Size = new System.Drawing.Size(622, 43);
			this.label8.TabIndex = 17;
			this.label8.Text = "THÔNG TIN JIG";
			this.label8.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// grdDataJig
			// 
			this.grdDataJig.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grdDataJig.Location = new System.Drawing.Point(0, 46);
			this.grdDataJig.MainView = this.grvDataJig;
			this.grdDataJig.Name = "grdDataJig";
			this.grdDataJig.Size = new System.Drawing.Size(623, 535);
			this.grdDataJig.TabIndex = 0;
			this.grdDataJig.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.grvDataJig});
			// 
			// grvDataJig
			// 
			this.grvDataJig.Appearance.HeaderPanel.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(51)))), ((int)(((byte)(204)))));
			this.grvDataJig.Appearance.HeaderPanel.ForeColor = System.Drawing.Color.White;
			this.grvDataJig.Appearance.HeaderPanel.Options.UseBackColor = true;
			this.grvDataJig.Appearance.HeaderPanel.Options.UseForeColor = true;
			this.grvDataJig.ColumnPanelRowHeight = 30;
			this.grvDataJig.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colKnifeCodeReal,
            this.colPeriodValueJig,
            this.colReal,
            this.colRateJig,
            this.colMinJig,
            this.colMaxJig,
            this.colKnifeDetailListID,
            this.colCheckValueTypeJig,
            this.colUnitJig,
            this.colSortOrderJig,
            this.colWorkingNameJig});
			this.grvDataJig.GridControl = this.grdDataJig;
			this.grvDataJig.Name = "grvDataJig";
			this.grvDataJig.OptionsView.ShowDetailButtons = false;
			this.grvDataJig.OptionsView.ShowGroupExpandCollapseButtons = false;
			this.grvDataJig.OptionsView.ShowGroupPanel = false;
			this.grvDataJig.PaintStyleName = "Flat";
			this.grvDataJig.RowCellStyle += new DevExpress.XtraGrid.Views.Grid.RowCellStyleEventHandler(this.grvDataJig_RowCellStyle);
			this.grvDataJig.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(this.grvDataJig_CellValueChanged);
			this.grvDataJig.KeyDown += new System.Windows.Forms.KeyEventHandler(this.grvDataJig_KeyDown);
			// 
			// colKnifeCodeReal
			// 
			this.colKnifeCodeReal.AppearanceCell.Options.UseTextOptions = true;
			this.colKnifeCodeReal.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colKnifeCodeReal.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colKnifeCodeReal.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colKnifeCodeReal.AppearanceHeader.Options.UseFont = true;
			this.colKnifeCodeReal.AppearanceHeader.Options.UseTextOptions = true;
			this.colKnifeCodeReal.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colKnifeCodeReal.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colKnifeCodeReal.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colKnifeCodeReal.Caption = "Mã dụng cụ";
			this.colKnifeCodeReal.ColumnEdit = this.repositoryItemMemoEdit2;
			this.colKnifeCodeReal.FieldName = "KnifeCodeReal";
			this.colKnifeCodeReal.Name = "colKnifeCodeReal";
			this.colKnifeCodeReal.OptionsColumn.AllowEdit = false;
			this.colKnifeCodeReal.OptionsColumn.AllowFocus = false;
			this.colKnifeCodeReal.OptionsColumn.AllowMove = false;
			this.colKnifeCodeReal.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colKnifeCodeReal.Visible = true;
			this.colKnifeCodeReal.VisibleIndex = 0;
			this.colKnifeCodeReal.Width = 229;
			// 
			// colPeriodValueJig
			// 
			this.colPeriodValueJig.AppearanceCell.Options.UseTextOptions = true;
			this.colPeriodValueJig.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colPeriodValueJig.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colPeriodValueJig.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colPeriodValueJig.AppearanceHeader.Options.UseFont = true;
			this.colPeriodValueJig.AppearanceHeader.Options.UseTextOptions = true;
			this.colPeriodValueJig.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colPeriodValueJig.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colPeriodValueJig.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colPeriodValueJig.Caption = "Tiêu chuẩn ";
			this.colPeriodValueJig.ColumnEdit = this.repositoryItemMemoEdit2;
			this.colPeriodValueJig.FieldName = "PeriodValue";
			this.colPeriodValueJig.Name = "colPeriodValueJig";
			this.colPeriodValueJig.OptionsColumn.AllowEdit = false;
			this.colPeriodValueJig.OptionsColumn.AllowFocus = false;
			this.colPeriodValueJig.OptionsColumn.AllowMove = false;
			this.colPeriodValueJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colPeriodValueJig.Visible = true;
			this.colPeriodValueJig.VisibleIndex = 1;
			this.colPeriodValueJig.Width = 159;
			// 
			// colReal
			// 
			...
			this.colReal.AppearanceHeader.Font = new System.Drawing.Font("Calibri", 11.25F, System.Drawing.FontStyle.Bold);
			...
			this.colReal.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colReal.Caption = "Thực tế";
			this.colReal.FieldName = "Real";
			this.colReal.Name = "colReal";
			this.colReal.OptionsColumn.AllowFocus = false;
			this.colReal.OptionsColumn.AllowMove = false;
			this.colReal.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colReal.Visible = true;
			this.colReal.VisibleIndex = 2;
			// 
			// colRateJig
			// 
			this.colRateJig.AppearanceCell.Options.UseTextOptions = true;
			this.colRateJig.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colRateJig.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colRateJig.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colRateJig.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colRateJig.AppearanceHeader.Options.UseFont = true;
			this.colRateJig.AppearanceHeader.Options.UseTextOptions = true;
			this.colRateJig.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colRateJig.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colRateJig.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colRateJig.Caption = "Đánh giá";
			this.colRateJig.FieldName = "Rate";
			this.colRateJig.Name = "colRateJig";
			this.colRateJig.OptionsColumn.AllowFocus = false;
			this.colRateJig.OptionsColumn.AllowMove = false;
			this.colRateJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.colRateJig.Visible = true;
			this.colRateJig.VisibleIndex = 3;
			// 
			// colMinJig
			// 
			this.colMinJig.Caption = "Min";
			this.colMinJig.FieldName = "MinValue";
			this.colMinJig.Name = "colMinJig";
			this.colMinJig.OptionsColumn.AllowMove = false;
			this.colMinJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colMaxJig
			// 
			this.colMaxJig.Caption = "Max";
			this.colMaxJig.FieldName = "MaxValue";
			this.colMaxJig.Name = "colMaxJig";
			this.colMaxJig.OptionsColumn.AllowMove = false;
			this.colMaxJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colKnifeDetailListID
			// 
			this.colKnifeDetailListID.Caption = "ID Jig";
			this.colKnifeDetailListID.FieldName = "KnifeDetailListID";
			this.colKnifeDetailListID.Name = "colKnifeDetailListID";
			this.colKnifeDetailListID.OptionsColumn.AllowMove = false;
			this.colKnifeDetailListID.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colCheckValueTypeJig
			// 
			this.colCheckValueTypeJig.Caption = "CheckValueType";
			this.colCheckValueTypeJig.FieldName = "CheckValueType";
			this.colCheckValueTypeJig.Name = "colCheckValueTypeJig";
			this.colCheckValueTypeJig.OptionsColumn.AllowMove = false;
			this.colCheckValueTypeJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colUnitJig
			// 
			this.colUnitJig.Caption = "Unit";
			this.colUnitJig.FieldName = "Unit";
			this.colUnitJig.Name = "colUnitJig";
			this.colUnitJig.OptionsColumn.AllowMove = false;
			this.colUnitJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colSortOrderJig
			// 
			this.colSortOrderJig.Caption = "SortOrder";
			this.colSortOrderJig.FieldName = "SortOrder";
			this.colSortOrderJig.Name = "colSortOrderJig";
			this.colSortOrderJig.OptionsColumn.AllowMove = false;
			this.colSortOrderJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// colWorkingNameJig
			// 
			this.colWorkingNameJig.Caption = "Mục kiểm tra";
			this.colWorkingNameJig.FieldName = "WorkingName";
			this.colWorkingNameJig.Name = "colWorkingNameJig";
			this.colWorkingNameJig.OptionsColumn.AllowMove = false;
			this.colWorkingNameJig.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			// 
			// panel1
			// 
			this.panel1.Controls.Add(this.cboBoPhan);
			...
			// cboBoPhan
			// 
			this.cboBoPhan.Font = new System.Drawing.Font("Calibri", 11.25F, System.Drawing.FontStyle.Bold);
			this.cboBoPhan.FormattingEnabled = true;
			this.cboBoPhan.Location = new System.Drawing.Point(426, 9);
			this.cboBoPhan.Name = "cboBoPhan";
			this.cboBoPhan.Size = new System.Drawing.Size(172, 26);
			this.cboBoPhan.TabIndex = 1;
			this.cboBoPhan.SelectedIndexChanged += new System.EventHandler(this.cboBoPhan_SelectedIndexChanged);
			this.cboBoPhan.TextChanged += new System.EventHandler(this.cboBoPhan_TextChanged);
			...
			this.label5.Location = new System.Drawing.Point(610, 43);
			...
			this.txtKnifeDetailCode.Location = new System.Drawing.Point(726, 42);
			this.txtKnifeDetailCode.Name = "txtKnifeDetailCode";
			this.txtKnifeDetailCode.Size = new System.Drawing.Size(172, 26);
			this.txtKnifeDetailCode.TabIndex = 5;
			this.txtKnifeDetailCode.TextChanged += new System.EventHandler(this.txtKnifeDetailCode_TextChanged);
			this.txtKnifeDetailCode.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtMaHang_KeyDown);
			// 
			// txtGoodsCode
			// 
			...
			this.txtGoodsCode.Location = new System.Drawing.Point(426, 42);
			...
			this.label4.Location = new System.Drawing.Point(906, 43);
			...
			this.mnuMenu.Location = new System.Drawing.Point(1162, 42);
			this.mnuMenu.Name = "mnuMenu";
			this.mnuMenu.RenderMode = System.Windows.Forms.ToolStripRenderMode.Professional;
			this.mnuMenu.Size = new System.Drawing.Size(101, 25);
			...
			this.txtMachine.Location = new System.Drawing.Point(726, 9);
			...
			this.cboCongDoan.Location = new System.Drawing.Point(1022, 42);
			this.cboCongDoan.Name = "cboCongDoan";
			this.cboCongDoan.Size = new System.Drawing.Size(126, 26);
			...
			this.cboCongDoan.TextChanged += new System.EventHandler(this.cboCongDoan_TextChanged);
			// 
			// txtOrder
			// 
			...
			this.txtOrder.Location = new System.Drawing.Point(127, 42);
			...
			this.txtWorkerCode.Location = new System.Drawing.Point(127, 9);
			this.txtWorkerCode.Name = "txtWorkerCode";
			this.txtWorkerCode.Size = new System.Drawing.Size(172, 26);
			this.txtWorkerCode.TabIndex = 0;
			this.txtWorkerCode.TextChanged += new System.EventHandler(this.txtWorkerCode_TextChanged);
			...
			this.menuStrip1.Location = new System.Drawing.Point(619, 468);
			...
			this.panel2.Size = new System.Drawing.Size(1280, 840);
			...
			this.lbly.Location = new System.Drawing.Point(1232, 12);
			this.lbly.Name = "lbly";
			...
			this.lblx.Location = new System.Drawing.Point(1186, 12);
			this.lblx.Name = "lblx";
			...
			this.btnSave1.Location = new System.Drawing.Point(1164, 917);
			this.btnSave1.Name = "btnSave1";
			this.btnSave1.Size = new System.Drawing.Size(110, 39);
			this.btnSave1.TabIndex = 0;
			this.btnSave1.Text = "NEXT";
			this.btnSave1.UseVisualStyleBackColor = true;
			this.btnSave1.Click += new System.EventHandler(this.btnSave1_Click);
			this.btnSave1.KeyUp += new System.Windows.Forms.KeyEventHandler(this.btnSave1_KeyUp);
			// 
			// btnBack
			// 
			...
			this.btnBack.Location = new System.Drawing.Point(6, 917);
			...
			this.Name = "frmHypMoldDaoJigLine";
			this.Text = "HYPOID PINION";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmHypMoldLine_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.grdDataJig)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.grvDataJig)).EndInit();
		...
		private DevExpress.XtraGrid.Columns.GridColumn colEvaluate;
		...
		private System.Windows.Forms.TextBox txtCurrentSTD;
		private System.Windows.Forms.Label label10;
		private System.Windows.Forms.Label label11;
		private System.Windows.Forms.Label label13;
		private System.Windows.Forms.Label label14;
		private System.Windows.Forms.TextBox txtCode;
		private System.Windows.Forms.TextBox txtCurrentATC;
		...
		private DevExpress.XtraGrid.GridControl grdDataJig;
		private DevExpress.XtraGrid.Views.Grid.GridView grvDataJig;
		private DevExpress.XtraGrid.Columns.GridColumn colKnifeCodeReal;
		private DevExpress.XtraGrid.Columns.GridColumn colPeriodValueJig;
		private DevExpress.XtraGrid.Columns.GridColumn colReal;
		private DevExpress.XtraGrid.Columns.GridColumn colRateJig;
		private DevExpress.XtraGrid.Columns.GridColumn colMinJig;
		private DevExpress.XtraGrid.Columns.GridColumn colMaxJig;
		private DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit repositoryItemMemoEdit2;
		private DevExpress.XtraGrid.Columns.GridColumn colKnifeDetailListID;
		private DevExpress.XtraGrid.Columns.GridColumn colCheckValueTypeJig;
		private DevExpress.XtraGrid.Columns.GridColumn colUnitJig;
		private DevExpress.XtraGrid.Columns.GridColumn colSortOrderJig;
		private DevExpress.XtraGrid.Columns.GridColumn colWorkingNameJig;
