...
namespace SD
{
	...
	{
		static string _ConnectionString = @"Server=LAPTOP-G3GTTN00\SQLEXPRESS;Database=SystemData;uid=sa;pwd=123@123a;";
		...
		public static string ConnectionString
		{
			get
			{
				...
				{
					string strPath = Application.StartupPath.ToString() + (IsReal ? @"\defaultSystemData.ini" : @"\defaultSystemData.ini");
